<?php
include '../config/koneksi.php'; // Ensure this file creates and connects using $conn
include '../library/fungsi.php';
session_start();

// Make sure to use the $conn object from koneksi.php
$aksi = new oop($conn);
...
<html>
<head>
    <title>CETAK STRUK <?php echo htmlspecialchars($pembayaran['id_pembayaran']); ?></title>
    <style type="text/css">
        #trans {
...
<body onload="window.print()" style="font-family:monospace;">
    <table style="background: url('../images/struk.png') center no-repeat; background-size: 50%;">
        <tr>
        ...
        <tr>
            ...
            <td align="left">:</td>
            <td align="left"><?php echo htmlspecialchars($pembayaran['id_pelanggan']); ?></td>
            <td>&nbsp;&nbsp;&nbsp;</td>
        ...
        <tr>
            ...
            <td align="left">:</td>
            <td align="left"><?php echo htmlspecialchars($pelanggan['nama']); ?></td>
            <td>&nbsp;&nbsp;&nbsp;</td>
        ...
        <tr>
            ...
            <td align="left">:</td>
            <td align="left"><?php echo htmlspecialchars($tarif['kode_tarif']); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="6" align="center"><center>BRIGHT POWER Menyatakan struk ini sebagai bukti pembayaran yang sah</center></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="6" align="center">Rincian Tagihan dapat diakses di www.brightpower.co.id, Informasi Hubungi Call Center:123</td>
        </tr>
        <tr>
            <td colspan="6" align="center">BRIGHT POWER/<?php echo htmlspecialchars($_SESSION['nama_agen'] . "/" . $pembayaran['waktu_bayar']); ?></td>
        </tr>
    </table>
</body>
</html>
